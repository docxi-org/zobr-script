...
Срезы 1–12 завершены (бэкенд + фронтенд + REST API + i18n + unified guide + per-agent roles + explicit conclude + MCP OAuth).
Ревью проведено: `REVIEW-ACTION-PLAN.md` — 40 action items (P0–P3).
...
- `TODO.md` — срезы 9–12 завершены.
- `REVIEW-ACTION-PLAN.md` — **ГЛАВНЫЙ план работ**: 40 items (P0–P3) из ревью. Следующий шаг — P0 (5 critical items, ~6h).
...
- `reviews/` — 8 детальных отчётов ревью + SUMMARY.md.
