...
Срезы 1–13 завершены (бэкенд + фронтенд + REST API + i18n + unified guide + per-agent roles + explicit conclude + MCP OAuth + agent-side retrieve).
